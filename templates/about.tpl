...
{% block content %}
	<div class="container">
		...
		<p>The Whiteboard takes full advantage of the desktop computer, utilising <i>all three</i> mouse buttons, and numerous keyboard shortcuts for you other hand.</p>
		...
		<p>The complete list of tools and features can be found on the <a href="/docs">docs page</a>.</p>
