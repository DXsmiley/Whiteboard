...
{% block content %}
	<div class="container">
		...
		<h2>Features</h2>
		<p>The whiteboard features all the necicary basics: a pencil, eraser, text tool and several colours, along with the fancier features of image uploading and linking, panning, solid shapes, and a presenter mode.</p>
